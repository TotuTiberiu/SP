...
subplot(1,3,1), plot(t1,s1,'.-r'),xlabel('Timp [s]'),grid,title('Semnal dreptungiular periodic in functie de t1')

subplot(1,3,2), plot(t2,s2,'.-r'),xlabel('Timp [s]'),grid,title('Semnal dreptungiular periodic in functie de t2')

subplot(1,3,3), plot(t3,s3,'.-r'),xlabel('Timp [s]'),grid,title('Semnal dreptungiular periodic in functie de t3')
